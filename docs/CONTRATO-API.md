...
| POST   | `/clientes/:id/registros-obra`                             | `rh_admin` o `jefe_area`     | Registros de obra del cliente; idempotente por número (D-66)                                                                            |
| PATCH  | `/clientes/:id/registros-obra/:roId`                       | `rh_admin` o `jefe_area`     | Número y descripción                                                                                                                    |
| PATCH  | `/clientes/:id/registros-obra/:roId/estado`                | `rh_admin` o `jefe_area`     | Baja y reactivación                                                                                                                     |
