...
| POST   | `/empleados`                                               | quien puede crear ese `tipo` | Persona + adscripción en transacción (D-33); duplicados (D-34); `numeroEmpleado` obligatorio, con o sin empresa (D-54) |
| GET    | `/empleados/:id`                                           | ver empleados                | 404 si no es visible                                                                                                   |
| PATCH  | `/empleados/:id`                                           | quien puede crear ese `tipo` | Datos de la persona, `numeroEmpleado` incluido (D-54); no toca acceso, estado ni adscripciones                        |
