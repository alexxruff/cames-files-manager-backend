...
| Empleados — **alta**              | 6.2       | ✅     | Persona + adscripción en transacción, permisos por tipo, duplicados (D-32 a D-34); `numeroEmpleado` obligatorio y de la persona, con o sin empresa (D-50, D-54)            |
