...
| `contracts`           | `Contract`          | ✅     | Contrato = fase (`nombre` y `fase`, D-75), con el SIROC embebido y único global (D-70)               |
...
| Contratos y SIROC                  | 6.7       | ✅     | Contrato = fase, con `nombre` y `fase` como etiquetas separadas (D-75); SIROC embebido y único global; traba los cambios del proyecto (D-70)                                                                                  |
