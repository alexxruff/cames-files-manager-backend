...
const modelos = {
  ...
  Role: require('../api/v1/roles/roleModel'),
  ...
  IncidentType: require('../api/v1/incidentTypes/incidentTypeModel'),
  MachineIncident: require('../api/v1/machineIncidents/machineIncidentModel'),
